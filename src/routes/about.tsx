...
import { BOARD, INFO_OFFICER, MAIN_FUNCTIONS, STATS } from "@/lib/site-data";

export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About the Authority — SGPRPTA" },
      {
        name: "description",
        content:
      ...
      { property: "og:title", content: "About the Authority — SGPRPTA" },
      {
        property: "og:description",
        content: "Leadership, history and statistics of SGPRPTA.",
      },
    ],
  }),
  component: About,
...
function About() {
  return (
    <SiteLayout>
      <PageHero title="About the Authority" subtitle="Board of Directors, history, mandate and statistics." />

      <section className="container-narrow py-16">
        <SectionHeading eyebrow="Our Story" title="History & Current Situation" />
        <div className="mx-auto mt-8 max-w-3xl space-y-4 text-center text-muted-foreground">
          <p>
            The Sabaragamuwa Provincial Road Passenger Transport Authority was established by the
            relevant charter under <strong>Act No. 1 of 1994</strong>, following the vesting of
            passenger-transport powers in the Provincial Council in 1987.
          </p>
          <p>
            The institute operates under the Chief Ministry of the Sabaragamuwa Provincial Council
            and serves passengers, bus owners, drivers, conductors and staff of the transport
            authority. The <strong>Head Office is in Ratnapura</strong> and the{" "}
            <strong>District Office is in Kegalle</strong>.
          </p>
      ...
      <section className="container-narrow py-16">
        <SectionHeading eyebrow="Mandate" title="Main Functions in Detail" />
      ...
      <section className="bg-primary-dark py-16 text-primary-foreground">
        <div className="container-narrow">
          <SectionHeading eyebrow="Statistical Figures" title="The Authority at a Glance" invert />
